...
//static ull PREC = 1e5;
static const size_t PAGE_SIZE = -1; //TROCAR ESSA LINHA DE LUGAR PODE AFETAR O SCRIPT DE CONSULTA
//static const size_t BTREE_PAGE_SIZE = 4096;
static const size_t MIN_BTREE_LEAF_NUM = -1; //TROCAR ESSA LINHA DE LUGAR PODE AFETAR O SCRIPT DE CONSULTA
