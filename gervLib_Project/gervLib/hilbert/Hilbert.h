...
//                    fprintf(stderr, "11all coordinate values in all vectors in points must be <= 2^p-1=%llull but found points[%zul]\n", max_x, i);
//                    throw std::runtime_error("all coordinate values in all vectors in points must be ... bla bla");
