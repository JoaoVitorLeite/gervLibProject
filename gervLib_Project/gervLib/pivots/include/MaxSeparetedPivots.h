...
class MaxSeparetedPivots : public Pivot<DType>
{

    public:

        MaxSeparetedPivots();
        MaxSeparetedPivots(Dataset<DType>* sample, DistanceFunction<BasicArrayObject<DType>>* function, size_t nPivots) : Pivot<DType>(){

            this->setPivotType(PIVOT_TYPE::MAXSEPARETED);
            generatePivots(sample, function, nPivots);

        }
        MaxSeparetedPivots(Dataset<DType>* sample, DistanceFunction<BasicArrayObject<DType>>* function, size_t nPivots, size_t seed) : Pivot<DType>(){
...
template <class DType>
MaxSeparetedPivots<DType>::MaxSeparetedPivots()
{
...
template <class DType>
void MaxSeparetedPivots<DType>::generatePivots(Dataset<DType> *sample, DistanceFunction<BasicArrayObject<DType>> *df, size_t nPivots, size_t seed, std::vector<std::string> args)
{
