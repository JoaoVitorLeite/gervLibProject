...
pivot_type=("RANDOM" "GNAT" "CONVEX" "KMEDOIDS" "MAXSEPARATED" "MAXVARIANCE" "SELECTION" "PCA" "SSS" "HFI" "IS" "WDR" "BPP")
sample_size=(1.0 1.0 1.0 0.2 1.0 0.3 0.3 0.2 0.2 0.2 0.5 0.5 0.5)
