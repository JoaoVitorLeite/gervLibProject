...
struct qt_meta_stringdata_TestSSSPivots_t {
    const uint offsetsAndSize[32];
    char stringdata0[119];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TestSSSPivots_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TestSSSPivots_t qt_meta_stringdata_TestSSSPivots = {
    {
...
QT_MOC_LITERAL(112, 6) // "test12"
    ...
    "TestSSSPivots\0initTestCase\0\0cleanupTestCase\0"
    "test1\0test2\0test3\0test4\0test5\0test6\0"
    "test7\0test8\0test9\0test10\0test11\0test12"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TestSSSPivots[] = {
...
const QMetaObject TestSSSPivots::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_TestSSSPivots.offsetsAndSize,
    qt_meta_data_TestSSSPivots,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TestSSSPivots_t
...
void *TestSSSPivots::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestSSSPivots.stringdata0))
