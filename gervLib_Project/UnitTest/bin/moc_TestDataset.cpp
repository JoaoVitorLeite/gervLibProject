...
struct qt_meta_stringdata_CLASSTestDatasetENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSTestDatasetENDCLASS = QtMocHelpers::stringData(
    "TestDataset",
    "initTestCase",
    "",
    "cleanupTestCase",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTestDatasetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTestDatasetENDCLASS_t qt_meta_stringdata_CLASSTestDatasetENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTestDatasetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TestDataset::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSTestDatasetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTestDatasetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTestDatasetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TestDataset, std::true_type>,
        // method 'initTestCase'
...
void *TestDataset::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTestDatasetENDCLASS.stringdata0))
